...
const siteData = {
  business: {
    name: "Evoplex Systems",
    legalName: "Evoplex Systems",
    tagline: "Evolved Security Technology Solutions",
    description: "Evoplex Systems delivers next-generation security technology including CCTV, access control, and integrated alarm systems for Harare's homes and businesses.",
    phone: "+263 77 306 2357",
    phoneRaw: "+263773062357",
    whatsappNumber: "263773062357",
    email: "info@evoplexsystems.co.zw",
    address: "5322+P3P, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 4.7,
    ratingRounded: 5,
    ...
    cookieConsentKey: "evoplex-systems-cookie-consent",
    socialLinks: {
      facebook: "#",
      instagram: "#",
      linkedin: "#",
  ...
  hero: {
    ...
    titleParts: [
      ...
      { text: "FOR MODERN THREATS." },
    ],
    subtitle: "Evoplex Systems delivers next-generation security technology including CCTV, access control, and integrated alarm systems for Harare's homes and businesses.",
    ctaPrimary: "Request Assessment",
    ctaSecondary: "Our Technology",
    trustBadge: "250+ Clients Served",
    backgroundImages: [
  ...
  stats: [
    { number: "250+", label: "Installations Done" },
  ...
  homeTestimonials: [
    { text: "Evoplex Systems installed a complete CCTV system at my home and I finally feel safe. The cameras are crystal clear and I can check my phone from anywhere.", name: "Wellington Moyo", role: "Homeowner, Borrowdale", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "We contracted Evoplex Systems for our estate security and they delivered a fully integrated system -- cameras, access control, and electric fencing all working together.", name: "Chenai Dziva", role: "Property Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "Evoplex Systems installed security cameras at our school and the improvement in safety and accountability has been remarkable. Parents are very reassured.", name: "Tapiwa Gondo", role: "School Headmaster", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
    { text: "The alarm system Evoplex Systems installed has already paid for itself. Fast response, reliable monitoring, and their technicians are always available when needed.", name: "Martha Zvobgo", role: "Business Owner, CBD", rating: 5, avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80" },
  ],
  ...
  about: {
    ...
    story: [
      "Evoplex Systems represents the evolution of security technology in Zimbabwe. Founded in 2020, we brought a fresh, technology-first approach to an industry that needed modernisation.",
      "With 250+ installations and growing, we specialise in smart, integrated systems where CCTV, access control, and alarms work together as one intelligent platform.",
    ],
    values: [
    ...
    team: [
      { name: "Team Leader", role: "Director", bio: "Leading Evoplex Systems with expertise and vision.", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80" },
  ...
  reviews: {
    ...
    items: [
      { text: "Evoplex Systems installed a complete CCTV system at my home and I finally feel safe. The cameras are crystal clear and I can check my phone from anywhere.", name: "Wellington Moyo", role: "Homeowner, Borrowdale", rating: 5 },
      { text: "We contracted Evoplex Systems for our estate security and they delivered a fully integrated system -- cameras, access control, and electric fencing all working together.", name: "Chenai Dziva", role: "Property Manager", rating: 5 },
      { text: "Evoplex Systems installed security cameras at our school and the improvement in safety and accountability has been remarkable. Parents are very reassured.", name: "Tapiwa Gondo", role: "School Headmaster", rating: 5 },
      { text: "The alarm system Evoplex Systems installed has already paid for itself. Fast response, reliable monitoring, and their technicians are always available when needed.", name: "Martha Zvobgo", role: "Business Owner, CBD", rating: 5 },
      { text: "Remote viewing works perfectly. I can see my house from my office phone thanks to Evoplex Systems's CCTV setup.", name: "Simba Karonga", role: "Remote Monitoring Client", rating: 5 },
      { text: "Electric fence installation was done in one day with minimal disruption. Evoplex Systems are efficient and tidy.", name: "Douglas Mhizha", role: "Homeowner", rating: 5 },
      { text: "The access control system Evoplex Systems installed at our offices has completely eliminated unauthorised entry.", name: "Linda Masuku", role: "Corporate Client", rating: 5 },
      { text: "Night vision on these cameras is incredible. Evoplex Systems recommended the right specs for our needs.", name: "Patrick Makoni", role: "Night Security Client", rating: 5 },
      ...
      { text: "Annual maintenance contract with Evoplex Systems keeps everything working perfectly. Proactive, not reactive.", name: "Brian Mutema", role: "Maintenance Client", rating: 5 },
    ],
  },
  ...
  contact: {
    ...
    branches: [
      { name: "Main Office", address: "5322+P3P, Harare, Zimbabwe", phone: "+263 77 306 2357", email: "info@evoplexsystems.co.zw" },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hello Evoplex! I'm interested in security technology.",
    backgroundImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1920&q=85",
  },

  footer: {
    description: "Evoplex Systems delivers next-generation security technology including CCTV, access control, and integrated alarm system...",
    copyright: "Evoplex Systems",
  },
};
